...
/*
 * @Author: YingBinXia 
 * @Date: 2019-07-23 09:05:30 
 * @Last Modified by: YingBinXia
 * @Last Modified time: 2019-07-23 09:46:36
 */
namespace Pub;
class ReturnCode{

    public static function guid($prex){
		if (function_exists('com_create_guid')){
			return $prex.com_create_guid();
		}else{
    ...
    public static function returnJsonData($code='1001',$data='',$other=''){
        echo json_encode(array(
            'code' => $code,
            'data' => $data,
            'other' => $other,
            'msg' => self::recodes($code)
		));
		die;
    }

    public static function _number($string){
		$regex = "/\/|\~|\!|\@|\#|\\$|\%|\^|\&|\*|\(|\)|\（|\）|\_|\+|\{|\}|\:|\<|\>|\?|\[|\]|\,|\.|\/|\;|\'|\`|\-|\=|\\\|\||\s+/";
    	return preg_replace($regex,"_",$string);
    }
    
    public static function recodes($number){    
        $arr = array(
            '-20002' => '参数类型不正确',
            '-20001' => '参数格式不正确',
            '-1011' => '素材上传失败',
            ...
            '1037' => '',
            '1039' => '',
            '1051' => '图片上传失败,建议:2M,支持bmp/png/jpeg/jpg/gif格式',
            '1053' => '文章内容上传失败:图文消息的具体内容,必须少于2万字符,小于1M',
            '1055' => '',
            '1057' => '',
            '1059' => '',
            '1071' => '',
